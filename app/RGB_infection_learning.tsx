  ...
  useEffect (() => {
    async function prepare() {
      ...
      const model = await tf.loadGraphModel(
        bundleResourceIO(
          require("../assets/model/RGB_model/model.json"),
          [
            require("../assets/model/RGB_model/group1-shard1of6.bin"),
            require("../assets/model/RGB_model/group1-shard2of6.bin"),
            require("../assets/model/RGB_model/group1-shard3of6.bin"),
            require("../assets/model/RGB_model/group1-shard4of6.bin"),
            require("../assets/model/RGB_model/group1-shard5of6.bin"),
            require("../assets/model/RGB_model/group1-shard6of6.bin"),
          ]
        ));
      ...
      console.log("PROBS:", await probs.array());
